...
@property (nonatomic, readonly) UILabel *stringLabel2;
...
@synthesize overlayWindow, hudView, fadeOutTimer, stringLabel, stringLabel2, imageView;
...
+ (void)showWithImage:(UIImage*)image withString1:(NSString *)string1 string2:(NSString *)string2 duration:(NSTimeInterval)duration {
    [[SVStatusHUD sharedView] showWithImage:image withString1:string1 string2:string2 duration:duration];
}
...
- (void)setStatusWithString1:(NSString *)string1 andString2:(NSString *)string2
{	
    CGFloat hudWidth = 160;
    CGFloat hudHeight = 160;
	...
	self.stringLabel.hidden = NO;
	self.stringLabel.text = string1;
	self.stringLabel2.hidden = NO;
	self.stringLabel2.text = string2;
}
...
- (void)showWithImage:(UIImage *)image withString1:(NSString *)string1 string2:(NSString *)string2 duration:(NSTimeInterval)duration
{
	...
	[self setStatusWithString1:string1 andString2:string2];
...
- (UILabel *)stringLabel {
    if (stringLabel == nil) {
        stringLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 110, 160, 20)];
...
- (UILabel *)stringLabel2 {
    if (stringLabel2 == nil) {
        stringLabel2 = [[UILabel alloc] initWithFrame:CGRectMake(0, 130, 160, 20)];
		stringLabel2.textColor = [UIColor whiteColor];
		stringLabel2.backgroundColor = [UIColor clearColor];
		stringLabel2.adjustsFontSizeToFitWidth = YES;
		stringLabel2.textAlignment = UITextAlignmentCenter;
		stringLabel2.baselineAdjustment = UIBaselineAdjustmentAlignCenters;
		stringLabel2.font = [UIFont boldSystemFontOfSize:16];
		stringLabel2.shadowColor = [UIColor colorWithWhite:0 alpha:0.7];
		stringLabel2.shadowOffset = CGSizeMake(1, 1);
        stringLabel2.numberOfLines = 0;
		[self.hudView addSubview:stringLabel2];
    }
    return stringLabel2;
}
